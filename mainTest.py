...
def main():
		...
		b = torch.randint(high=50, size=(dim2, dim3))
		print(a)
		print(b)
		#a=a[:,:,:].detach().cpu()
		#b=b[:,:].detach().cpu()
		ref = torch.matmul(a, b)
		dut, util, cycles, PUs_access_count,AccumulatorBitsCount,Input_A_BitsCount,Input_B_BitsCount,MultiplierToggle,AccumulatorToggle,InputAToggle,InputBToggle = c_smt_sa.exec(a[None,:,:].detach().cpu(),b[:,:].detach().cpu(), dim2, 1, 1024)
